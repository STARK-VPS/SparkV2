...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SparkV2.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("AV", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SparkV2 -X kill
screen -S SparkV2 ./SparkV2
done
]])  
file:close() 
...
token = sudos.token 
sudo_users = {1127044647,1127044647,1127044647}
--- start functions ↓
--------------------------------------------------------------------------------------------------------------
...
if hash or SudoBot(msg) or sudo2(msg) then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or CoSu(msg) then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1127044647) then  
var = 'صـاحـب الـسـورس' -- @BBLBB0
elseif tonumber(user_id) == tonumber(1127044647) then
var = 'مـــطــور الـسـورس' -- @BBLBB0
elseif tonumber(user_id) == tonumber(1127044647) then
var = 'مطور السورس' -- @BBLBB0
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'سبارك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
if not Can_or_NotCan(chat,user) then
tdcli_function ({
...
local SparkV2_Msg = ''  
if msgs < 100 then 
SparkV2_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SparkV2_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SparkV2_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SparkV2_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SparkV2_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SparkV2_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SparkV2_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SparkV2_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SparkV2_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SparkV2_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SparkV2_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SparkV2_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SparkV2_Msg = 'رب التفاعل'  
end 
return SparkV2_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 SPARK")  
...
--------------------------------------------------------------------------------------------------------------
function SourceSparkV2(msg,data) -- بداية العمل
if msg then
...
Namebot = (database:get(bot_id..'Name:Bot') or 'سبارك')
...
{{text = '⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 ⊁', url="t.me/XRXNR"}},
} 
local Keyboard = {
{'LUCIFER','SPARK'},
{'نسبه الكره','نسبه الرجوله'},
{'نسبه الحب','نسبه الانوثه'},
{'ايدي','العاب سبارك','سورس','تغير الايدي'},
...
send(msg.chat_id_, msg.id_,SparkV2_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SparkV2.lua')
os.execute('wget https://raw.githubusercontent.com/STARK-VPS/SparkV2/master/SparkV2.lua')
send(msg.chat_id_, msg.id_,'☭ تم تحديث السورس')
dofile('SparkV2.lua')  
end
if text == 'الاصدار ' and sudo2(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☭ اصدار سورس سبارك { s: 6.7}')
end
...
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
else
...
send(msg.chat_id_, msg.id_,'☭  عدد الجروبات الان ← { '..#group..' }'..SparkV2k..''..SparkV2..'\n☭  الان عدد الجروبات الحقيقي ← { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ☭ العضو ← ['..result.title_..'](t.me/'..(username or 'XRXNR')..')'
status  = '\n ☭ تم ترقيته مطور'
...
usertext = '\n ☭ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'XRXNR')..')'
status  = '\n ☭ تم ترقيته مطور'
...
local SparkV21_Msg = database:get(bot_id.."SparkV21:Add:Filter:Rp2"..text..msg.chat_id_)   
if SparkV21_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XRXNR')..') \n ☭ '..SparkV21_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SparkV2_Msg and not Special(msg) then  
local SparkV2_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SparkV2_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☭ ["..SparkV2_Msg.."] \n")
else
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/XRXNR)}\n ☭ ["..SparkV2_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☭ عذرا ← {["..data.first_name_.."](T.ME/XRXNR)}\n ☭ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
'\n ☭ الرابط {['..LinkGp..']}'
BBLBB0 = {}  
BBLBB0.inline_keyboard = {{{text = 'مغادره المجموعه', callback_data="/BBLBB01 "..IdChat}},}
if not SudoBot(msg) then
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. SUDO .. '&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(BBLBB0)) 
end
end
end,nil) 
end,nil) 
...
database:sadd(bot_id.."SparkV2:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SparkV2:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SparkV2:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SparkV2:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SparkV2:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SparkV2:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SparkV2:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SparkV2:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SparkV2:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SparkV2:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SparkV2:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SparkV2:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SparkV2:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☭ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "XRXNR")..")\n☭ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SparkV2:teh"..msg.chat_id_).."} بجانب اسمك\n☭ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local SparkV2ChengName = database:get(bot_id.."SparkV2:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SparkV2ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SparkV2ChengName..']')
database:del(bot_id.."SparkV2:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SparkV2ChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."SparkV2:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SparkV2ChengUserName = database:get(bot_id.."SparkV2:Cheng:UserName"..data.id_)
if not data.username_ then 
if SparkV2ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SparkV2ChengUserName..']')
database:del(bot_id.."SparkV2:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SparkV2ChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SparkV2:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SparkV2ChengPhoto = database:get(bot_id.."SparkV2:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SparkV2ChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."SparkV2:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SparkV2ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SparkV2:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local TWEET_Msg = { 
"‏من ترك أمرهُ لله، أعطاه الله فوق ما يتمنَّاه♥️ ", 
...
"‏☭ مره واحد بلديتنا كان بيدق مسمار فى الحائط فالمسمار وقع منه فقال له :تعالى ف مجاش, فقال له: تعالي ف مجاش. فراح بلديتنا رامي على المسمار شوية مسمامير وقال: هاتوه. ",
"‏ ‏☭ واحدة عملت حساب وهمي ودخلت تكلم جوزها منه.. ومبسوطة أوي وبتضحك.. سألوها بتضحكي على إيه؟ قالت لهم أول مرة يقول لي كلام حلو من ساعة ما اتجوزنا.",
"☭  مره سباركاني دعك المصباح طلعله جني..   جاب بيه مستيكة.",
...
"🧸البس طرحه امك او اختك ",
"🧸لا خلاص معتش في سمحتك",
" 🧸اتصل لاخوك و قول له انك سويت حادث و الخ....",
"🧸تكلم باللغة الانجليزية الين يجي دورك مرة ثانية لازم تتكلم اذا ما تكلمت تنفذ عقاب ثاني",
"🧸تروح عند شخص تقول له ",
"🧸 اتصل على ابوك و قول له انك رحت مع بنت و احين هي حامل....",
"🧸اتصل على امك و قول لها انك ",
...
[◍ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ◍](t.me/XRXNR)

[◍ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ◍](t.me/XRXNR)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 ⊁',url="t.me/XRXNR"}},
{{text = '⌯ LUCIFER ⊁',url="t.me/BBLBB0"}},
{{text = '⌯ SPARK ⊁',url="t.me/BBLBB0"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝐃𝐄𝐕 ⊁',url="t.me/BBLBB0"}},
{{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..dofile("./info.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BBLBB0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end


if text == 'LUCIFER' then
local Text =[[
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/XRXNR"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸' then
local Text = [[ 
☭من أحسن السورسات على التليجرام سورس سبارك☭
...
if text == 'العاب سبارك' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ☭ اهلا في قائمه الالعاب المتطوره سورس سبارك  ☭ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XRXNR')..') \n ☭ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XRXNR')..') \n ☭ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☭تم قفل البوتات بالطرد\n☭تم وضع الايدي بدون صوره\n☭تم قفل التكرار بالطرد\n☭تم قفل الروابط\n☭تم قفل التوجيه\n☭تم قفل الملصقات\n☭تم قفل المتحركه\n☭تم قفل الفيديو\n☭تم قفل السب\n☭تم قفل التعديل\n☭تم قفل الفارسيه\n☭تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XRXNR')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/STARK-VPS/SparkV2/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☭ اهلا بك في متجر ملفات سبارك\n ☭ ملفات السورس ↓\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ☭ علامة تعني { ✔️ } ملف مفعل\n ☭ علامة تعني { ✖ } ملف معطل\n ☭ قناة سورس سبارك ↓\n".." ☭ [اضغط هنا لدخول](t.me/XRXNR) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/STARK-VPS/SparkV2/master/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه سبارك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☭ تم مسح قائمه سبارك')
return false
end

if text == 'قائمه سبارك' and Sudo(msg) then
...
if text == ("رفع سبارك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
...
if text and text:match("^رفع سبارك @(.*)$") and Sudo(msg) then
local username = text:match("^رفع سبارك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
...
if text and text:match("^رفع سبارك (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سبارك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
...
if text == ("تنزيل سبارك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
...
if text and text:match("^تنزيل سبارك @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سبارك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
...
if text and text:match("^تنزيل سبارك (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سبارك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local XRXNR = database:get(bot_id..'text:ch:user')
if XRXNR then
send(msg.chat_id_, msg.id_,'['..XRXNR..']')
...
local UserName = (b.username_ or "SRC-SparkV2")
...
function Function_SparkV2(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SparkV2, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SparkV2, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☭ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'XRXNR')..')'
status  = '\n ☭ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☭ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☭ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'XRXNR')..')'
...
database:set(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ☭ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SparkV21:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SparkV21:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ☭ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SparkV21:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SparkV21:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SparkV21:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ☭ ارسل الكلمه الان")  
database:set(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SparkV21:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SparkV21:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SparkV21:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SparkV21:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SparkV21:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SparkV21:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ☭ قائمة المنع \n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n"
for k,v in pairs(list) do  
local SparkV2_Msg = database:get(bot_id.."SparkV21:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..SparkV2_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☭ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'XRXNR')..')'..'\n ☭ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ☭ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:SparkV2:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:SparkV2:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SparkV2:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"☭ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:SparkV2:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:SparkV2:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:SparkV2:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:SparkV2:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:SparkV2:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:SparkV2:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:SparkV2:List:Rd:Sudo")
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☭', url="t.me/XRXNR"}},
{{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..dofile("./info.lua").botUserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."XRXNR:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."XRXNR:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."XRXNR:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."XRXNR:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☭تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."XRXNR:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."XRXNR:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سبارك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:SparkV2:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"☭ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:SparkV2:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SparkV2:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SparkV2:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:SparkV2:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"☭تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:SparkV2:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبارك').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل ايدي صوره' or text == 'تفعيل ايدي بالصوره' or text == 'تفعيل الايدي صوره' or text == 'تفعيل الايدي بالصوره' and Manager(msg) then   
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبارك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سبارك')
local SparkV2_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
send(msg.chat_id_, msg.id_,'['..SparkV2_Msg[math.random(#SparkV2_Msg)]..']') 
return false
end
if text == "بوت" then 
local Namebot = (database:get(bot_id..'Name:Bot') or 'سبارك') 
local DRAGON_Msg = { 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XRXNR')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SparkV2dx(msg.chat_id_, msg.id_, ' ☭ ايدي المجموعة ← ( '..msg.chat_id_..' )\n ☭ عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n ☭ عدد المحظورين ← ( *'..data.kicked_count_..' )*\n ☭ عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
database:set(bot_id.."BBLBB0:TRGMA"..msg.chat_id_,"close")
end
if text == "تفعيل الترجمه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☭تم تفعيل الترجمه')
database:set(bot_id.."BBLBB0:TRGMA"..msg.chat_id_,"open")
end
if text and text:match("^ترجمه انجليزي (.*)$") and database:get(bot_id.."BBLBB0:TRGMA"..msg.chat_id_) == "open" then
...
if text and text:match("^ترجمه عربي (.*)$") and database:get(bot_id.."BBLBB0:TRGMA"..msg.chat_id_) == "open" then
...
if Text and Text:match("^/BBLBB01 (.*)$") then
local chatid = Text:match("^/BBLBB01 (.*)$")
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سبارك')
...
SparkV2 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SparkV2)
...
--------------------------------------------------------------------------------------------------------------
SourceSparkV2(data.message_,data)
...
------------------------------------------------------------------------
local SparkV2Abot = database:get(bot_id.."SparkV21:Add:Filter:Rp2"..text..result.chat_id_)   
if SparkV2Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☭ ["..SparkV2Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SparkV21_Msg = database:get(bot_id.."SparkV21:Add:Filter:Rp2"..text..result.chat_id_)   
if SparkV21_Msg then    
send(msg.chat_id_, msg.id_," ☭ "..SparkV21_Msg)
